...
Export Image from Cytoscape and include into R
...
```
    ...
    ##  [1] "Ripple"               "size_rank"            "default"             
    ##  [4] "BioPAX_SIF"           "Gradient1"            "Sample3"             
    ##  [7] "Marquee"              "Minimal"              "Big Labels"          
    ## [10] "Directed"             "Solid"                "default black"       
    ## [13] "Curved"               "BioPAX"               "Nested Network Style"
    ## [16] "Universe"             "Sample1"              "Sample2"
...
```
    ...
    ## IGRAPH a85e6be UNW- 845 1544 -- 
    ## + attr: name (v/c), weight (e/n)
    ## + edges from a85e6be (vertex names):
...
```
    ...
    ## + 845/845 vertices, named, from a85e6be:
...
```
    ...
    ## + 1544/1544 edges from a85e6be (vertex names):
    ##  [1] ph_1061 --AACY020068177 ph_1258 --AACY020207233
    ##  [3] ph_3164 --AACY020207233 ph_1033 --AACY020255495
    ##  [5] ph_10996--AACY020255495 ph_11038--AACY020255495
    ##  [7] ph_11040--AACY020255495 ph_11048--AACY020255495
...
grep looks for things with ph\_
...
81 non phage nodes (look at genenet observations 845-764)
